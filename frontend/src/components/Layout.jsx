...
const navGroups = [
  ...
  },
  {
    ...
    items: [
      { path: '/file-viewer', icon: 'FileText', label: 'File Viewer' },
      { path: '/ingestion-pipelines', icon: 'Cpu', label: 'Ingestion' },
      { path: '/connector-syncs', icon: 'Database', label: 'Connectors' },
      { path: '/review-assignments', icon: 'Eye', label: 'Review Assignments' },
      { path: '/redaction-jobs', icon: 'Sparkles', label: 'Redaction Jobs' },
      { path: '/production-packages', icon: 'Package', label: 'Production Packages' },
      { path: '/notification-delivery', icon: 'Mail', label: 'Notifications' },
      { path: '/rbac-permissions', icon: 'Lock', label: 'RBAC' },
      { path: '/audit-binders', icon: 'CheckSquare', label: 'Audit Binders' },
      { path: '/background-jobs', icon: 'Clock', label: 'Jobs' },
      { path: '/ai-governance', icon: 'Brain', label: 'AI Governance' },
    ],
  },
  {
    label: 'AI TOOLS',
    items: [
      ...
      { path: '/ai-cost-projection', icon: 'Scale', label: 'Cost Projection' },
      { path: '/ai-predictive-coding-feedback', icon: 'Brain', label: 'Coding Feedback' },
      { path: '/ai-agentic-search-chain', icon: 'Search', label: 'Agentic Search' },
      { path: '/ai-batch-tag-suggest', icon: 'Hash', label: 'Batch Tag Suggest' },
      { path: '/ai-privilege-rate-report', icon: 'Lock', label: 'Privilege Rate' },
    ],
  },
  {
    label: 'CUSTOM VIEWS',
...
function getPageTitle(pathname) {
  const map = {
    ...
    '/redaction-jobs': 'Redaction Jobs',
    '/production-packages': 'Production Packages',
    '/notification-delivery': 'Notification Delivery',
    '/rbac-permissions': 'RBAC Permissions',
    '/audit-binders': 'Audit Binders',
    ...
    '/ai-cost-projection': 'AI Cost Projection',
    '/ai-predictive-coding-feedback': 'AI Predictive Coding Feedback',
    '/ai-agentic-search-chain': 'AI Agentic Search Chain',
    '/ai-batch-tag-suggest': 'AI Batch Tag Suggest',
    '/ai-privilege-rate-report': 'AI Privilege Rate Report',
